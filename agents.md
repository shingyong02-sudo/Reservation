...
- [x] 階段七之三：P0/P1 安全性漏洞修補、交易事務化取消與防重送按鈕 (v=20260807g)
- [x] 階段七之四：修正後台側邊欄，使登入者資訊與登出按鈕永遠置底固定不隨頁面捲動 (v=20260807i)
- [x] 階段七之五：在後台側欄新增回到前台住戶預約頁的「線上預約」連結 (v=20260807i)
- [x] 階段七之六：帳號列表行內資料編輯與密碼重設優化 (v=20260807k)
- [x] 階段七之七：修正 Transaction 事務安全性規則在預約/取消時的 P0 權限阻擋 bug (v=20260807l)
- [ ] 階段七之八：後台實測收尾——測試清單已備妥（`docs/admin-test-checklist.md`），
