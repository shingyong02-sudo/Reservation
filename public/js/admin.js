import { db, auth } from "./firebase-config.js?v=20260807f";
...
} from "./shared.js?v=20260807f";
import { watchAuth, login, logout, writeLog, canEnterAdmin } from "./auth.js?v=20260807f";
