import { db, auth } from "./firebase-config.js?v=20260807g";
import {
...
} from "./shared.js?v=20260807g";
import { watchAuth, login, logout, writeLog, canEnterAdmin } from "./auth.js?v=20260807g";
